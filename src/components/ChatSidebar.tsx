...
export const ChatSidebar: React.FC<ChatSidebarProps> = () => {
  ...
  // Compute active connections from connectionStates
  const activeConnections = Object.keys(connectionStates).filter(
  ...
  const saveRename = (e?: React.FormEvent) => {
    e?.preventDefault();
    if (renamingPeerId) {
      renameChat(renamingPeerId, renameValue);
                ...
                <li key={chat.peerId}>
                  ...
                  >
                    ...
                    <div
                      ...
                      onClick={() => !isRenaming && selectChat(chat.peerId)}
                    >
                      {isRenaming ? (
                        <form
                          onSubmit={saveRename}
